...
const Footer = () => {
  return (
    <footer className="z-50 w-full footer px-4 pb-8 pt-24 text-white md:px-16">
        ...
        <div className="flex flex-col items-start gap-4 md:flex-row lg:gap-2">
          <div className="mt-8 flex items-start justify-start gap-2 md:mt-0">
            ...
            <h1 className="mb-4 flex flex-col text-2xl font-bold md:hidden">
              <span className="__className_1e998c tracking-widest">
                MetaLogic
              </span>
          ...
          <div className="flex w-full flex-col justify-between md:flex-row xl:flex-col">
            <h1 className="mb-4 hidden md:block ">
              <span className="__className_1e998c text-3xl font-semibold tracking-widest">
                MetaLogic
              </span>
              <br />
        ...
        <div className="flex flex-col gap-y-8 md:mx-auto md:flex-row md:gap-8 lg:gap-16 xl:mx-0">
          <div>
            ...
            <ul className="flex flex-col gap-2 text-xs">
              ...
              <li>
                <a href="/contact/partner">Partnership</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2 text-xs">
              ...
              <li>
                <a href="/services/cloud-computing">Cloud Computing Services</a>
              </li>
              <li>
                <a href="/services/qa">Quality Assurance and Testing</a>
              </li>
              <li>
                <a href="/services/ui-ux">UI/UX Designing</a>
              </li>
              <li>
                <a href="/services/support">Maintenance and Support</a>
              </li>
              <li>
                <a href="/services/devops">Dev Ops</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2 text-xs">
              <li>
                <a href="/careers">Careers at MetaLogic</a>
              </li>
              <li>
